...
public class DataCiteRetrofitSyncClient implements DataCiteService {
     ...
     */
    @Override
    public void createDoi(Datacite42Schema body) {
        syncCall(dataCiteRetrofitService.create(body));
    }
     ...
     */
    @Override
    public Datacite42Schema getDoi(String doi) {
     ...
     */
    @Override
    public void updateDoi(String doi, Datacite42Schema body) {
        syncCall(dataCiteRetrofitService.update(doi, body));
    }
